...
public class AbstrcationDocs {
	
	/*
	 * ----------------- Abstraction --------------------------------------
	 * # process of hiding implementation details in the program is known as 
	 *   abstraction.
	 *   
	 ...
	 *                     
	 *          # every abstract class must have at least one child class and child class
